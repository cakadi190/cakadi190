            ...
            <div class="container">
                ...
                <div class="row justify-content-center mt-5 align-items-center">
                    <div class="col-lg-8">
                        ...
                        <p>Koleksi penghargaan dan sertifikasi terbaruku.</p>
...
export default {
  ...
  data() {
    return {
      certs: [
        {year: 2022, type: 'cert', name: 'Sertifikasi Sololearn CSS', 'date': '1 Mei 2022', 'desc': 'Sertifikasi kursus mahir CSS dari Sololearn', 'image' : require('~/images/sertifikasi/css.jpg')},
        {year: 2022, type: 'cert', name: 'Sertifikasi Sololearn HTML', 'date': '30 April 2022', 'desc': 'Sertifikasi kursus mahir HTML dari Sololearn', 'image' : require('~/images/sertifikasi/html.jpg')},
